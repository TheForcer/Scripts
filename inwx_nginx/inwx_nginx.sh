...
# Configuration ###################################################################
USERNAME="secureim"                          	      # Your username at INWX
PASSWORD="ourarchingthingspattedthedistiller"		  # Your password at INWX
APIHOST="https://api.domrobot.com/xmlrpc/" 			  # API URL from inwx.de
IPV4="5.1.93.15"									  # Static IP of your server v4
IPV6="2a00:f820:417::5845:5d8e"						  # Static IP of your server v6
